...
function PopularCardPost({ post, setPosts }) {
  ...
  // distinguising between image and video media
  let isvideo = false;
  if (post.picUrl) {
    ...
    <>
      ...
      <Segment basic>
        <Card color="black" fluid>
          ...
          {/* displaying the users profile picture on their post */}
          <Card.Content>
            <Image
              floated="left"
            ...
            {/* displaying users username and role on the post */}
            <Card.Header>
              <Link href={`/login`}>
                <a>
            ...
            {/* displaying the company and location on the post */}
            <Card.Meta
              content={[post.company, post.location].filter(Boolean).join(", ")}
            />

            {/* displaying the keywords on the post */}
            <b>
              <Card.Meta
          ...
          <Card.Content extra>
            <div>
              ...
              {/* report when there are more than one report and not a super user */}
              ...
              {/* report for when there no reports and not a super user */}
              {reports.length === 0 && post.user.role !== "Super" && (
                <Modal
                  closeIcon
                  open={openReport}
            ...
            {/* displaying the "View More" button if there are more than 3 comments */}
            {comments.length > 3 && (
              <Button
                content="View More"
                color="blue"
