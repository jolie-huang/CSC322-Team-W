...
function NoImageModal({
  ...
  return (
    <Card fluid>
      {/* displaying the delete post button only for this user and super user */}
      <Card.Content>
        ...
        {/* displaying the users username and users role on the post */}
        <Card.Header>
        ...
        {/* displaying the post company and location */}
        <Card.Meta
        ...
        >
          ...
          <Label as="a" color="black">
            {/* displaying all the users that have read this post */}
            <ReadsList
              postId={post._id}
              trigger={
                reads.length > 0 && (
      ...
      <Card.Content extra>
        <div>
          ...
          <Button as="div" labelPosition="right">
            ...
            <Label as="a" basic color="brown" pointing="left">
              {/* dispalying all the users that have disliked this post */}
              <DisLikesList
                postId={post._id}
                trigger={
                  dislikes.length > 0 && (
          ...
          {/* report button for all users except super users */}
          {reports.length > 0 && post.user.role !== "Super" && (
            ...
            >
              ...
              >
                {/* display all of the users that have reported this post */}
                <ReportPostList
                  postId={post._id}
                  trigger={
                    reports.length > 0 && (
          ...
          {/* report pop-up when there are no reports on the post */}
          {reports.length === 0 && post.user.role !== "Super" && (
            <Modal
              closeIcon
              open={openReport}
        ...
        >
          {/* dispalying all the comments on this post */}
          {comments.length > 0 &&
            comments.map(
              (comment, i) =>
                i < 3 && (
