...
function CardPost({ post, user, setPosts, setShowToastr }) {
  ...
  return (
    <>
      ...
      <Segment basic>
        {/* displaying the users image or video for their post */}
        <Card color="black" fluid>
          ...
          <Card.Content>
            <Image
              ...
              circular
            />
            {/* only allowing the delete post button display for this user or super user */}
            ...
            {/* showing the user's username on their post */}
            <Card.Header>
            ...
            {/* displaying Trendy icon (star) nect to trendy posts along with post type and time created*/}
            <Card.Meta>
              {post.kind === "Trendy" && <Icon name="star" color="yellow" />}
              {post.type} Post @ {calculateTime(post.createdAt)}
            </Card.Meta>

            {/* displaying the company and location for the post */}
            <Card.Meta
              content={[post.company, post.location].filter(Boolean).join(", ")}
            />

            {/* displaying the keywords for the post */}
            <b>
              <Card.Meta
            ...
            {/* hiding the post content until read button is clicked */}
            <Card.Description
              style={{
            ...
            <Button
              ...
              floated="right"
            >
              {/* read button - when clicked the text blur goes away */}
              ...
              <Label as="a" color="black">
                {/* showing what users have read this post */}
                <ReadsList
                  postId={post._id}
                  trigger={
                    reads.length > 0 && (
          ...
          <Card.Content extra>
            <div>
              ...
              <Button as="div" labelPosition="right">
                ...
                <Label as="a" basic color="blue" pointing="left">
                  {/* showing the users who have liked this post */}
                  <LikesList
                    postId={post._id}
                    trigger={
                      likes.length > 0 && (
              ...
              <Button as="div" labelPosition="right">
                ...
                <Label as="a" basic color="brown" pointing="left">
                  {/* showing this users who have disliked this post */}
                  <DisLikesList
                    postId={post._id}
                    trigger={
                      dislikes.length > 0 && (
              ...
              {/* showing the report icon on the post for everyone except Super users */}
              {reports.length > 0 && post.user.role !== "Super" && (
                ...
                >
                  ...
                  >
                    {/* list the users have reported this post */}
                    <ReportPostList
                      postId={post._id}
                      trigger={
                        reports.length > 0 && (
            ...
            {/* displaying this posts comments */}
            {comments.length > 0 &&
              comments.map(
                (comment, i) =>
                  i < 3 && (
            ...
            {/* displaying the "View More" button once there are more than 3 comments */}
            {comments.length > 3 && (
              <Button
                content="View More"
                color="blue"
