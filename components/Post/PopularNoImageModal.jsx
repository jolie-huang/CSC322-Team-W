      ...
      <Card.Content>
        ...
        >
          ...
          <Label as="a" color="black">
            {/* displaying all the uers that have read this post */}
            <ReadsList
              postId={post._id}
              trigger={
                reads.length > 0 && (
      ...
      <Card.Content extra>
        ...
        <Button as="div" labelPosition="right">
          ...
          <Label as="a" basic color="violet" pointing="left">
            {/* displaying all the users that have commented on this post */}
            {comments.length > 0 && (
              <span>
                {`${comments.length} ${
        ...
        {/* report for when there are more than zero reports and user is not super user */}
        ...
        {/* report for when there are zero reports and user is not super user */}
        {reports.length === 0 && post.user.role !== "Super" && (
          <Modal
            closeIcon
            open={openReport}
