...
// Functional component for rendering the profile header section
...
function ProfileHeader({
  ...
  // State variables for managing loading states, report data, and modal states
  ...
  // Generating a formatted user role string
  ...
  // Function to handle form submission when reporting a profile
  ...
  return (
    <>
      <Segment>
        ...
        <Grid stackable>
          <Grid.Column width={11}>
            <Grid.Row>
              ...
              />
              {/* Displaying a star icon for Trendy users */}
            ...
            <Grid.Row stretched>
              ...
              {/* THIS IS WHERE YOU CAN ADD SOCIAL MEDIA LINKS */}
              {profile.social ? (
                <List size="mini">
          ...
          {/* Displaying user's profile picture and follow button */}
          ...
          <Grid.Column width={5} stretched style={{ textAlign: "center" }}>
            ...
            <br />
            {/* Displaying Follow/Unfollow button if not own account */}
            ...
            <Modal.Content>
              ...
              <Form error={error !== null} onSubmit={handleSubmit}>
                <Message
                  ...
                  header="Oh no!"
                />
                {/* Text area for entering the report description */}
        ...
        {/* Actions for Super user or the profile owner */}

        {(user.role === "Super" || user._id === profile.user._id) && (
          <>
            {/* Popup for confirming profile deletion */}
        ...
        {user.role === "Super" && user._id !== profile.user._id && (
          ...
          >
            ...
            {/* cancel or confirm adding warning */}
            <Modal.Actions>
        ...
        {user.role === "Super" && user._id !== profile.user._id && (
          // {/* Modal for removing a warning from a user */}
          ...
          >
            ...
            <Modal.Actions>
              ...
              {/* Button to confirm removing a warning */}
        ...
        {user.role === "Super" && user._id !== profile.user._id && (
          // {/* Modal for resetting warnings for a user */}
          ...
          >
            ...
            <Modal.Actions>
              {/* Button to cancel resetting warnings */}

              <Button color="red" onClick={() => setOpenResetWarning(false)}>
                <Icon name="remove" style={{ cursor: "pointer" }} /> No
              </Button>
              {/* Button to confirm resetting warnings */}
